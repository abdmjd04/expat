...
const blogPosts = [{
  ...
  excerpt: 'Everything you need to know about relocating to Portugal, from visa requirements to finding housing and setting up utilities.',
  ...
  excerpt: 'Stay healthy during and after your move with these important health considerations for expats living abroad.',
  ...
  excerpt: 'Simple but effective exercises to help your body recover after long flights and minimize the effects of jet lag.',
  ...
  excerpt: "What to pack (and what to leave behind) when you're relocating or traveling for an extended period.",
  ...
  excerpt: 'Sarah shares her experience moving from the UK to Portugal, including challenges, surprises, and advice for others considering the move.',
  ...
  excerpt: 'An overview of healthcare systems in popular expat destinations, including insurance requirements and accessing medical care.',
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-16 bg-blue-600 text-white rounded-xl p-8">
          ...
          <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-4">
            <input type="email" placeholder="Your email address" className="flex-grow px-4 py-3 rounded-md text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" required />
            <button type="submit" className="bg-white text-blue-600 px-6 py-3 rounded-md font-medium hover:bg-blue-50 transition-colors">
              Get Free Guide
            </button>
          </form>
        </div>
